    ...
    def _run_trial(self, space_sample, trial_no, X, y, X_eval, y_eval, cv=False, num_folds=3, model_file=None,
        ...
        if succeeded:
            ...
            if model_file is None or len(model_file) == 0:
                model_file = '%05d_%s' % (trial_no, space_sample.space_id)
            ...
            if self.history.improved_reward(trial):
                estimator.save('%05d_%s' % (trial_no, space_sample.space_id), True)
